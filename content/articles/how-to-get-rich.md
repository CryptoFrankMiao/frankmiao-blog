...
titleZh: 如何致富
subtitle: You get rich by owning things, not by working for wages.
date: 2026-03-08
tags: [创业, 财富, 职业]
excerpt: 致富的关键是拥有股权，而不是靠工资。创业是获得股权最直接的方式，但不是唯一方式。
originalUrl: http://paulgraham.com/wealth.html
---
...
选择具有复利效应的工作。有些工作你做10年只是重复第一年的经验10次。有些工作让你每年都比去年强得多。选择后者。

寻找那些如果解决得当会有巨大回报的问题。不要解决那些即使完美解决也价值有限的问题。

你需要成为某个领域的专家，然后利用这个专长解决有价值的问题。专长很难获得，因为这需要真正的兴趣和长期投入。

杠杆很重要。代码和媒体是新的杠杆形式——它们可以无限复制，边际成本为零。
...
> "You get rich by owning things, not by working for wages."
